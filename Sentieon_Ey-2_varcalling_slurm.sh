...
# Only the variables OUTPUTDIR, FILES, DBPATH, and SCRATCH should need to be changed from person to pers
on, and/or sample to sample. Example of samplesheet.csv is also included in this repo.
...
THREADS=24
OUTPUTDIR=/home/groups/hpcbio/RNA-Seq/projects/lixin/2023Nov-scRNASeq/results/VariantCalling/Ey_2/
FILES=/home/groups/hpcbio/RNA-Seq/projects/lixin/2023Nov-scRNASeq/results/VariantCalling/samplesheets/ey_2_samplesheet.csv
